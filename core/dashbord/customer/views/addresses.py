...
class CustomerAddressListView(LoginRequiredMixin, HasCustomerAccessPermission, ListView):
    template_name = "dashbord/customer/addresses/address-list.html"
...
class CustomerAddressCreateView(LoginRequiredMixin, HasCustomerAccessPermission, SuccessMessageMixin, CreateView):
    template_name = "dashbord/customer/addresses/address-create.html"
    ...
    def form_valid(self, form):
        ...
        return redirect(reverse_lazy("dashbord:customer:address-edit", kwargs={"pk": form.instance.pk}))
        

    def get_success_url(self):
        return reverse_lazy("dashbord:customer:address-list")


class CustomerAddressEditView(LoginRequiredMixin, HasCustomerAccessPermission, SuccessMessageMixin, UpdateView):
    template_name = "dashbord/customer/addresses/address-edit.html"
    ...
    def get_success_url(self):
        return reverse_lazy("dashbord:customer:address-edit", kwargs={"pk": self.get_object().pk})


class CustomerAddressDeleteView(LoginRequiredMixin, HasCustomerAccessPermission, SuccessMessageMixin, DeleteView):
    template_name = "dashbord/customer/addresses/address-delete.html"
    
    success_url = reverse_lazy("dashbord:customer:address-list")
