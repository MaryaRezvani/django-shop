...
class NewsletterListView(LoginRequiredMixin, HasAdminAccessPermission, ListView):
    title = "لیست خبرنامه"
    template_name = "dashbord/admin/newsletters/newsletter-list.html"
    paginate_by = 10
...
class NewsletterDeleteView(LoginRequiredMixin, HasAdminAccessPermission, SuccessMessageMixin, DeleteView):
    title = "حذف خبرنامه"
    template_name = "dashbord/admin/newsletters/newsletter-delete.html"
    success_url = reverse_lazy("dashbord:admin:newsletter-list")
